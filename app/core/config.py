...
class Settings(BaseSettings):
    # The model_config attribute is used to configure the behavior of
    # the Settings class. It specifies that the environment variables
    # should be loaded from a .env file with UTF-8 encoding,
    #  and any extra environment variables not defined in the Settings
    ...
    # The following attributes define the configuration settings for the application,
...
# cached settings instance ensures that the environment variables are only read
# once per process, improving performance.
@lru_cache
